  ...
  <div class="settings">
    <div class="localSettings">
      ...
      <div class="showSubCardsOption">
        <Switch
          class="option"
          :value="forceShowAllCards"
          @change="(val: boolean) => (forceShowAllCards = val)"
        />
        <label class="showSubCardsText" for="showSubCardsCheckbox"
          >Force show all cards</label
        >
      </div>
      <div class="showSubCardsOption">
        <Switch
          class="option"
          :value="showSubCards"
          @change="(val: boolean) => (showSubCards = val)"
        />
        <label class="showSubCardsText" for="showSubCardsCheckbox"
          >Show Subcards</label
        >
      ...
      <div class="showSubCardsOption">
        <Switch
          class="option"
          :value="colorAllSame"
          @change="(val: boolean) => (colorAllSame = val)"
        />
        <label class="showSubCardsText" for="showSubCardsCheckbox"
          >Color all subcards like 1st parent</label
        >
      </div>
    </div>
