...
<template>
  ...
  <div class="header">
    ...
    <button class="settingsButton" @click="settingsOpened = !settingsOpened" />
  </div>
  ...
  <div class="container">
    <div class="cards">
      ...
      <div
        class="newBoardItem cardContainer"
        @click="() => (creatingNewBoard = true)"
      >
        <div></div>
      </div>
    </div>
